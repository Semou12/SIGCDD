...
==========================================================================================*/
function format_jsonstring_to_jsobject(json_string){
    json_string = json_string.replace(/u&#39;/g,'&#39;');
    json_string = json_string.replace(/([\wÀ-ÿ])&#39;([\wÀ-ÿ])/g,"$1 $2");
...
(function (window, document, $) {
        ...
        $(".search-input .input").on("keyup", function (e) {
            ...
            if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
                ...
                if (value != "") {
                    ...
                    $.getJSON("../../../static/stack/app-assets/data/" + $filename + ".json", function (
                        data
                    ) {
    ...
    i18next
        ...
        .init({
                ...
                fallbackLng: "en",
                backend: {
                    loadPath: "../../../static/stack/app-assets/data/locales/{{lng}}.json",
                },
                returnObjects: true
            },
            function (err, t) {
 ...
 */
	if ( $(".google_maps")){
		...
		window.loadGoogleMaps = function() {
			...
			script_tag.setAttribute("src", "https://maps.google.com/maps/api/js?callback=gMapsCallback&key=AIzaSyAN4XV1NImFqYvrez8cuV2IBYKfl9fGdQk");
...
/* ~ END: GOOGLE MAPS */
    ...
    if ($('._stackdatetimerangepicker').length > 0){

        //Calendars are not linked
	$('._stackdatetimerangepicker').daterangepicker({
		timePicker: true,
...
if ($('.stackdatetimerangepicker').length > 0){

    $(".stackdatetimerangepicker").daterangepicker({
        autoUpdateInput: false,
        minYear: 2012,
        showDropdowns: true,
        ...
        picker.element.val(picker.startDate.format(picker.locale.format))+' - '+picker.element.val(picker.endDate.format(picker.locale.format));
    });



    $('.stackdatetimerangepicker').on('apply.daterangepicker', function(ev, picker) {
      $(this).val(picker.startDate.format('DD/MM/YYYY HH:mm:ss') + ' - ' + picker.endDate.format('DD/MM/YYYY HH:mm:ss'));
  });

  $('.stackdatetimerangepicker').on('cancel.daterangepicker', function(ev, picker) {
      $(this).val('');
  });
